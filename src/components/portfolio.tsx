              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-muted-foreground">james@example.com</span>
                  </div>
                  <div className="flex items-center space-x-3">
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <Button variant="outline" className="w-full justify-start" asChild>
                    <a href="https://linkedin.com/in/jamesabbotteqdam" target="_blank" rel="noopener noreferrer">
                  ...
                  <Button variant="outline" className="w-full justify-start" asChild>
                    <a href="https://twitter.com/jamesabbott" target="_blank" rel="noopener noreferrer">
                      <Twitter className="w-5 h-5 mr-3" />
                      Twitter / X
                    </a>
                  </Button>
                  <Button variant="outline" className="w-full justify-start" asChild>
                    <a href="https://jamesabbotteqdam.com" target="_blank" rel="noopener noreferrer">
